...
export default async function TalentsPage() {
  ...
  const [{ data: talents }, { data: talentCategories }, { data: allAgents }, { data: agentTypes }, { data: allAgencies }] = await Promise.all([
  ...
  return <TalentsClient talents={(talents ?? []) as any} talentCategories={talentCategories ?? []} allAgents={(allAgents ?? []) as any} agentTypes={agentTypes ?? []} allAgencies={allAgencies ?? []} />
}
